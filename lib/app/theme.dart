...
class AppTheme {
  static const Color cBg = Color(0xFF0D0E13);
  static const Color cSurface = Color(0xFF151720);
  static const Color cEdge = Color(0xFF212431);
  static const Color cAccent = Color(0xFF38BDF8);
  static const Color cAccent2 = Color(0xFF7DD3FC);
  static const Color cInk = Color(0xFFF0F9FF);
